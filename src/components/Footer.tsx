      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-xl font-bold mb-4">Historisches Museum Ernsthausen</h3>
            <p className="text-gray-300 mb-4">
              Entdecken Sie die faszinierende Geschichte unserer Schule und Region. 
              Seit 1890 bewahren wir das kulturelle Erbe für kommende Generationen.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/exhibitions" className="text-gray-300 hover:text-white transition-colors">Ausstellungen</Link></li>
              <li><Link href="/events" className="text-gray-300 hover:text-white transition-colors">Veranstaltungen</Link></li>
              <li><Link href="/booking" className="text-gray-300 hover:text-white transition-colors">Buchungen</Link></li>
              <li><Link href="/info" className="text-gray-300 hover:text-white transition-colors">Besucherinfo</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 sm:mt-0">
            ...
            <Link href="/imprint" className="text-gray-300 hover:text-white text-sm transition-colors">
              Impressum
            </Link>
